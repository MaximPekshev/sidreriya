(function($){
    ...
    /* ---------------------------------------------
     ...
     --------------------------------------------- */
    // function init_popup(){
    //     if($(window).width() + kt_get_scrollbar_width() >= 100){
    //         if($('body').hasClass('home')){
    //             //Open directly via API
    //             $.magnificPopup.open({
    //               items: {
    //                 src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><h3>Сидрерия</h3><p class="notice">Для доступа необходимо подтвердить совершеннолетний возраст</p></div><form"><button class="button primary">Мне уже 18!</button></form></div></div>',  //can be a HTML string, jQuery object, or CSS selector
    //                 type: 'inline'
    //               }
    //             });
    //         }
