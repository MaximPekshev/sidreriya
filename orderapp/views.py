	...
	if order:
	    ...
	    <html>
	      ...
	      <div style="max-width: 610px; width:100%">
			...
			<p>	
				На данный момент действуют акции:<br> -15% на весь сидр «с собой»<br> -10% на основное меню при самовывозе<br>
			</p>
			<p>
	...
	def post(self, request):
		...
		if serializer.is_valid(raise_exception=True):
			...
			try:
				...
				pass	
			# logger.info({"order_data": 'Заказ {} от {} успешно создан!'.format(order.order_number, order.date.strftime("%d-%m-%Y"))})
			return JsonResponse(
				data={
